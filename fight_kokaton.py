...
class Bird:
    ...
    def __init__(self, num: int, xy: tuple[int, int]):
        ...
        self.img = self.imgs[(+5, 0)]  # 右向きコウカトンをデフォ１にする
...
class Bomb:
    ...
    def __init__(self):
        ...
        """
        rad = random.randint(10, 100)  # Define 'rad' before using it
...
class ScoreBoard:
    ...
    def display_score(self, screen: pg.Surface):
        ...
        black = (0, 0, 0)
        white = (255, 255, 255)
        text = self.font.render(f"score:{self.killed_bombs}", True, self.text_color)
...
def main():
    ...
    while True:
        ...
        bomb_effects = [effect for effect  in bomb_effects if effect.boom_effect(screen)]
        pg.display.update()
        tmr += 1
        clock.tick(50)
